...
GHCINC= ${BDD_PATH} ${ABSTRACT2_PATH} ${TSL2_PATH} ${TSL2_PATH}/frontend ${TSL2_PATH}/solver ${TSL2_PATH}/internal ${DEBUGGER2_PATH} ${TSL2_PATH}/abstract ${BDD_PATH} ${UTIL_PATH} ${GRAPHDRAW_PATH} ${ABSTRACT_PATH} ${TSL_PATH} ${CUDD_HASKELL_PATH} ${HAST_PATH} ${CODEWIDGET_PATH}
